...
By default, `use_bio_tooltips()` uses jsDelivr CDN assets for the `bio-tooltips` browser bundle. A future CRAN-ready release may vendor pinned JS/CSS assets under `inst/htmltools/` for offline and regulated environments.
