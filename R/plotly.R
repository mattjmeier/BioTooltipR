...
bt_plotly_gene_hover_js <- function(species, gene_source, class = NULL) {
  gene_class <- paste(c("gene-tooltip", class), collapse = " ")
  config <- bt_json(list(
    species = species,
  ...
  paste(
    ...
    "  }",
    "",
    "  function initializeBioTooltips() {",
    ...
    "    var value = point ? point[config.geneSource] : null;",
    ...
    "    initializeBioTooltips();",
    "    gene.dispatchEvent(new MouseEvent('mouseover', { bubbles: true, view: window }));",
    "    gene.dispatchEvent(new MouseEvent('mouseenter', { bubbles: false, view: window }));",
    "  });",
    "",
    ...
    "    if (!target) return;",
    "",
    "    var gene = target.querySelector('.gene-tooltip');",
    "    if (gene) {",
    "      gene.dispatchEvent(new MouseEvent('mouseout', { bubbles: true, view: window }));",
    "      gene.dispatchEvent(new MouseEvent('mouseleave', { bubbles: false, view: window }));",
    "    }",
